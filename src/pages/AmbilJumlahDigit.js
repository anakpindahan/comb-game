...
const AmbilJumlahDigit = () => {
      ...
      {currNumber !== -1 ? (
        <div>
          <div>
            ...
            {currNumber > 0 && (<p className="helper-text"><FormattedMessage id="problems.centro22p1.helpertext"/></p>)}
            {validSteps().map((val) => {
        ...
        <div>
          <InputNForm text={<FormattedMessage id="problems.centro22p1.form.text"/>}
  ...
  return(
    <Problem problemId={"centro22p1"} board={board} />
  )
}
