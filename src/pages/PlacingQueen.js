...
const PlacingQueen = () => {
  const title = "Taruh Menteri"
  const desc = "Two players take turns placing queen on the squares of a chessboard, so that they cannot capture each other.  The player who is unable to do this loses."
